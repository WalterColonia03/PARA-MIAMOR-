(function (window) {
    ...
    Bloom = function (tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        // Paleta de colores otoñales cálidos (Earthy Warm Tones)
        var warmColors = [
            'rgb(224, 122, 95)',   // Coral
            'rgb(200, 76, 9)',     // Terracotta
            'rgb(212, 168, 69)',   // Mustard
            'rgb(114, 47, 55)',    // Wine
            'rgb(207, 181, 59)',   // Old Gold
            'rgb(77, 182, 172)',   // Warm Turquoise
            'rgb(138, 154, 91)',   // Moss Green
            'rgb(232, 126, 135)',  // Soft coral pink
            'rgb(255, 183, 77)',   // Amber
            'rgb(156, 102, 68)'    // Warm brown
        ];
        this.color = color || warmColors[random(0, warmColors.length - 1)];
